 ...
 */
#define DEF_PTC_CAL_OPTION CAL_AUTO_TUNE_RSEL
 ...
 */
#define DEF_SEL_FREQ_INIT FREQ_SEL_SPREAD
...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(5), 20, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                                   \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(3), 20, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                                   \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(2), 20, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                                   \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(1), 20, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                                   \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(0), 20, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_32                                   \
	}
